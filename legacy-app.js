...
document.title=(config.mosqueName||'Mosquée Anas Ibn Malik')+' — Horaires de prière';tick();setInterval(tick,1000);loadSettings(loadCalendar);setInterval(function(){render();},30000);setInterval(function(){loadSettings(function(){render();});},10000);
})();